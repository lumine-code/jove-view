...
class NotebookScrollmap {
  constructor(editor, Simplemap) {
    ...
    this.disposables.add(
      ...
      atom.config.onDidChange("jupyter-view.scrollmap.enabled", () => this.scheduleUpdate()),
      atom.config.onDidChange("jupyter-view.scrollmap.threshold", () => this.scheduleUpdate()),
      atom.config.onDidChange("jupyter-view.scrollmap.depth", () => this.scheduleUpdate()),
      atom.config.onDidChange("jupyter-view.input.maxHeight", () => this.scheduleUpdate()),
      atom.config.onDidChange("jupyter-view.output.maxHeight", () => this.scheduleUpdate()),
  ...
  isEnabled() {
    return atom.config.get("jupyter-view.scrollmap.enabled") !== false;
  }

  getThreshold() {
    return atom.config.get("jupyter-view.scrollmap.threshold") || 0;
  }

  getDepth() {
    return atom.config.get("jupyter-view.scrollmap.depth") || 0;
  }
